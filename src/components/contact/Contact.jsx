...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_w6qy4wp', 'template_9fwgivd', form.current, 'M4keCYXvP88YzjPqh')
    e.target.reset()
  };
    ...
    <div className="contact_container container grid">
        ...
        <div className="contact_info">
            <div className="contact_card">
                <i className="bx bx-mail-send content_card-icon"></i>
                <h3 className="contact_card-title">Email</h3>
                <span className="contact_card-data">nobregadavi@hotmail.com</span>
            ...
            <div className="contact_card">
                <i className="bx bxl-linkedin content_card-icon"></i>
                <h3 className="contact_card-title">Linkedin</h3>
                <span className="contact_card-data">David</span>

                <a href="https://linkedin.com/in/nobrega-davi" className="contact_button">Write me <i className="bx bx-right-arrow-alt contact_button-icon"></i></a>
